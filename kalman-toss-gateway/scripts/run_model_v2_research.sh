...
cd "$APP_ROOT"
exec 9>"$LOCK_DIR/model-v2-research.lock"
flock -n 9 || { echo "MODEL_V2_RESEARCH_ALREADY_RUNNING" >&2; exit 30; }
...
"$PY" -m research.model_v2.train_candidates \
...
printf 'MODEL_V2_RESEARCH_COMPLETE root=%s\n' "$ROOT"
