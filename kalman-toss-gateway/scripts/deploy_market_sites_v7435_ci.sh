...
if market=="KR":
    ...
    for marker in ("Research Benchmark · TOP-1 vs TOP-6","R5.1 2026 Ledger","FORWARD SHADOW","RECONSTRUCTED · 2026","US SESSION · KST END DATE","NEXT HOURLY CYCLE","ACTION · BUY / SELL","5M EXECUTION WATCHER","EXPECTED WEB UPDATE","sessionStatusHtml"):
