...
function pulseNum(x){
  ...
  if(x.kind==='price')return 'return S?.payload?.top3||[]}
...
load().catch(e=>{$('#m').innerHTML='<div class="card">LOAD FAILED · '+E(e.message)+'</div>'});+v.toLocaleString(undefined,{maximumFractionDigits:2});
